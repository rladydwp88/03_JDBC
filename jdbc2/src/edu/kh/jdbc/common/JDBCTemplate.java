 ...
 * 객체로 만들지 않고 메서드를 사용 할 수 있도록 하기 위해
...
public class JDBCTemplate {
	...
	// 커넥션, Statement(PrepareStatement), ResultSet
	...
	/** 전달 받은 Statement or PrepareStatement 둘 다 close()하는 메서드
	 * 	+ 다형성의 업캐스팅 적용
	 * 	-> PrepareStatement는 Statement의 자식
	 * @param stmt
	 */
