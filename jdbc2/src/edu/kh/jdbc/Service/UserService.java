...
public class UserService {
	...
	/** 6. ID, PW가 일치하는 회원의 USER_NO 조회 서비스
	 * @param userId
	 * @param userPw
	 * @return
	 */
	 ...
	 * @return
	 */
	public int multiInsetUser(List<User> userList) throws Exception {
		...
		for(User user : userList) {
			int result = dao.insertUser(conn, user);
			count += result; // 삽입 성공한 행의 개수를 conut 누적
		}
